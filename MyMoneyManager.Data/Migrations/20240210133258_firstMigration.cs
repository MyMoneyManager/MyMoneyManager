    ...
    public partial class firstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AboutUsAssets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AboutUsAssets_AboutUs_AboutUsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Remainders_Goals_GoalId",
                        column: x => x.GoalId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tranzactions_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tranzactions_Wallets_WalletId",
                        column: x => x.WalletId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AboutUsAssets_AboutUsId",
                table: "AboutUsAssets",
                column: "AboutUsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tranzactions_CategoryId",
                table: "Tranzactions",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Tranzactions_WalletId",
                table: "Tranzactions",
                column: "WalletId");
