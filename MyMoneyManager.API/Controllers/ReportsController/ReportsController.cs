...
namespace MyMoneyManager.API.Controllers.ReportsController;

public class ReportsController : BaseController
{
    private readonly IReportServie _reportServie;

    public ReportsController(IReportServie reportServie)
    {
        _reportServie = reportServie;
    }
    ...
    public async Task<IActionResult> InsertAsync([FromBody] ReportForCreationDto dto)
        => Ok(await _reportServie.AddAsync(dto));
    ...
    public async Task<IActionResult> GetAllAsync([FromQuery] PaginationParams @params)
        => Ok(await _reportServie.RetrieveAllAsync(@params));
    ...
    public async Task<IActionResult> GetByIdAsync([FromRoute] long id)
        => Ok(await _reportServie.RetrieveByIdAsync(id));
    ...
    public async Task<IActionResult> DeleteAsync([FromRoute] long id)
        => Ok(await _reportServie.RemoveAsync(id));
    ...
    public async Task<IActionResult> UpdateAsync([FromRoute] long id, [FromBody] ReportForUpdateDto dto)
        => Ok(await _reportServie.ModifyAsync(id, dto));
}
